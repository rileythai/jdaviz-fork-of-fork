...
>>>>>>> 007ae6ec (Change Spectrum1D to Spectrum)
...
def jdaviz_cube_fitswriter(spectrum, file_name, **kwargs):
    """This is a custom writer for Spectrum data cube.
    ...
    custom reader to be read back into Spectrum.

    Examples
    --------
    To write out a Spectrum cube using this writer:
...
io_registry.register_writer(
    "jdaviz-cube", Spectrum, jdaviz_cube_fitswriter, force=False, **kwargs)
